...
namespace Brainf_ck_sharp_UWP.UserControls.InheritedControls
{
    ...
    public class AnimatedComboBox : ComboBox
    {
        ...
        protected override void OnApplyTemplate()
        {
            ...
            if (_TranslationElement == null) throw new InvalidOperationException("The current template isn't valid");
        }
        ...
        protected override async void OnDropDownOpened(object e)
        {
            ...
            if (_TranslationElement != null)
            {
                ...
                int? count = ((ItemsSource as ICollection)?.Count ?? (ItemsSource as IEnumerable)?.Cast<object>().Count())
                             ?? Items?.Count;
