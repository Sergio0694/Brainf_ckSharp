    ...
    public class Brainf_ckBenchmark
    {
        ...
        public string HW_Debug()
        {
            Option<InterpreterSession> result = Brainf_ckInterpreterNew
                ...
                .WithSource(HelloWorldScript)
                .WithStdin(HelloWorldStdin)
                .WithMemorySize(64)
        ...
        public string M_Debug()
        {
            Option<InterpreterSession> result = Brainf_ckInterpreterNew
                .CreateDebugConfiguration()
                .WithSource(MultiplyScript)
                .WithStdin(MultiplyStdin)
                .WithMemorySize(64)
                .WithOverflowMode(OverflowMode.UshortWithNoOverflow)
                .TryRun();
        ...
        public string F_Debug()
        {
            Option<InterpreterSession> result = Brainf_ckInterpreterNew
                .CreateDebugConfiguration()
                .WithSource(FibonaccyScript)
                .WithStdin(FibonacciStdin)
                .WithMemorySize(64)
                .WithOverflowMode(OverflowMode.UshortWithNoOverflow)
                .TryRun();
