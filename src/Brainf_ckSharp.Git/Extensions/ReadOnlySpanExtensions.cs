        ...
        public static int GetxxHash32Code<T>(this ReadOnlySpan<T> span) where T : unmanaged
        {
            ...
            if (Vector.IsHardwareAccelerated)
            {
                ...
                if (length >= Vector<int>.Count * sizeof(int))
                {
                    ...
                    {
                        // SSE
                        hash = unchecked((hash * 397) ^ vh[0]);
                        hash = unchecked((hash * 397) ^ vh[1]);
                        hash = unchecked((hash * 397) ^ vh[2]);
                        hash = unchecked((hash * 397) ^ vh[3]);
                    }
                    else if (Vector<int>.Count == 8)
                    {
                        ...
                        hash = unchecked((hash * 397) ^ vh[2]);
                        hash = unchecked((hash * 397) ^ vh[3]);
                        hash = unchecked((hash * 397) ^ vh[4]);
                        hash = unchecked((hash * 397) ^ vh[5]);
                        hash = unchecked((hash * 397) ^ vh[6]);
                        hash = unchecked((hash * 397) ^ vh[7]);
                    }
                    else if (Vector<int>.Count == 16)
                    {
                        ...
                        hash = unchecked((hash * 397) ^ vh[6]);
                        hash = unchecked((hash * 397) ^ vh[7]);
                        hash = unchecked((hash * 397) ^ vh[8]);
                        hash = unchecked((hash * 397) ^ vh[9]);
                        hash = unchecked((hash * 397) ^ vh[10]);
                        hash = unchecked((hash * 397) ^ vh[11]);
                        hash = unchecked((hash * 397) ^ vh[12]);
                        hash = unchecked((hash * 397) ^ vh[13]);
                        hash = unchecked((hash * 397) ^ vh[14]);
                        hash = unchecked((hash * 397) ^ vh[15]);
                    }
                    else
                    {
